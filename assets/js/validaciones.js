(function () {
  ...
  // Mapa de comunas según región seleccionada
  ...
  // --- LÓGICA DINÁMICA DE REGIONES Y COMUNAS ---
  ...
  // --- FORMULARIO DE LOGIN (redirección admin) ---
  ...
  if (formNuevoProducto) {
    ...
    inicializarFormulario(
      ...
      () => {
        alert('Producto guardado exitosamente (Datos de prueba, sin backend conectado)');
  ...
  // --- BOTONES DE ELIMINAR EN TABLAS (ADMIN) ---
  ...
  botonesEliminar.forEach((boton) => {
    boton.addEventListener('click', (e) => {
      ...
      const confirmacion = confirm(`¿Estás seguro de que deseas eliminar "${nombreItem}" del inventario?`);
      if (confirmacion) {
        fila.remove();
